...
{Formations 3D pour Environnements à Risque} % Project
...
\cventry
{Analyste de Données} % Role
{Détection d'Anomalies dans les Données de Vol} % Project
{Collaboration Airbus} % Location
{2019 - 2020} % Date(s)
{ % Description(s)
\begin{cvitems}
